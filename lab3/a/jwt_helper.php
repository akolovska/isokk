...
// Класата за работа со .env фајлови
use Firebase\JWT\JWT;

// Класата за работа со JWT токени
use Firebase\JWT\Key;

// Класата за работа со клучеви при декодирање на JWT
...
function createJWT($userId, $username, $role): string
{
    ...
    $payload = [
        'iss' => 'localhost:8000', // Издавач на токенот
        'aud' => 'localhost:8000', // Публиката на токенот
